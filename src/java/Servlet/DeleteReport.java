...
public class DeleteReport extends HttpServlet 
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
    {
        ...
        out.println("<body><form action='DelReport' method='post'><table border=1>");
        out.println("<tr><th>TICK</th><th>ID</th><th>NAME</th><th>ADDRESS</th><th>GENDER</th><th>MTYPE</th><th>USERNAME</th></tr>");
        for(CustomerDetails s:al)
        {
             out.println("<tr><td><input type='checkbox' name='I' value="+s.id+"></td>");
        ...
        out.println("<tr><td colspan=7 ><center><input type='submit' value='Delete'>");
        out.println("<input type='reset' value='Clear'></center></td></tr>");
        out.println("</table>");
