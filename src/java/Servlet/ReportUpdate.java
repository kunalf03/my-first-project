...
public class ReportUpdate extends HttpServlet 
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
    {
        ...
        out.println("<body><form action='Upd' method='get'><table border=1>");
        ...
        {
             out.println("<tr><td><input type='radio' name='I' value="+s.id+"></td>");
        ...
        out.println("<tr><td colspan=7 ><center><input type='submit' value='Show'>");
